...
export const GameView = ({selectedTag,setSelectedTag}) => {
    ...
    const games=[
        ...
        },
        {
            ...
            GameDescription:'Unleash your creativity with vibrant strokes and playful textures on a blank canvas!',
            GamePhoto:GameCard2,
            Tag1:'Creativity',
    ...
    const filteredGames=selectedTag ? games.filter(game=>game.Tag1===selectedTag || game.Tag2===selectedTag) : games
  ...
  <div className='wrapper '>
       ...
       */}
       {filteredGames.map((game,index)=>(
        <GameCard key={index} GameName={game.GameName} GameDescription={game.GameDescription} GamePhoto={game.GamePhoto} Tag1={game.Tag1} Tag2={game.Tag2}  onTagClick={setSelectedTag}></GameCard>
       ))}
