...
const ArticlesCard = ({Title,Description,Link,readHandle}) => {
  return (
    <div className='box1 flex-col justify-start items-center flex'>
                ...
                <h1 className='Articles relative text-start  text-purple-300 text-3xl font-normal '>{Title}</h1>
                  ...
                  <p className='desc text-start'>{Description}</p>
                  <br />
                  <a href={Link} target="_blank"  rel="noopener noreferrer"  className="text-center w-full flex justify-start" ><button onClick={()=>{readHandle(Title)}} className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
